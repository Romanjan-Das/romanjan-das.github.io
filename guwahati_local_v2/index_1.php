...
<head>
        ...
        function fcheck(x)
    {
        ...
        {
            document.getElementById('image_source').value = "images/offer_thumbnail.jpg";
            document.getElementById('image1').value = "images/offer_slide_1.jpg";
            document.getElementById('image2').value = "images/offer_slide_2.jpg";
            document.getElementById('image3').value = "images/offer_slide_3.jpg";
        }
        else if(x==='ad_category_event')
        {
            document.getElementById('image_source').value = "images/event_thumbnail.jpg";
            document.getElementById('image1').value = "images/event_slide_1.jpg";
            document.getElementById('image2').value = "images/event_slide_2.jpg";
            document.getElementById('image3').value = "images/event_slide_3.jpg";
        }

        else if(x==='ad_category_job')
        {
            document.getElementById('image_source').value = "images/job_thumbnail.jpg";
            document.getElementById('image1').value = "images/job_slide_1.jpg";
            document.getElementById('image2').value = "images/job_slide_2.jpg";
            document.getElementById('image3').value = "images/job_slide_3.jpg";
        }
        else
        {
...
<input class="radio_class" type="radio" name="ad_category" value="offer" id="ad_category_offer" onclick="fcheck('ad_category_offer');" disabled>
...
<input class="radio_class" type="radio" name="ad_category" value="job" id="ad_category_job" onclick="fcheck('ad_category_job');" disabled>
<label for="ad_category_job" style="display:inline;">job</label>
</div>
<br>
<br>
<label for="text_1">Text line 1 :</label>
<input type="text" name="text_1" id="text_1" value=" ">
<br>
<label for="text_2">Text line 2 :</label>
<input type="text" name="text_2" id="text_2" value=" ">
<br>
<label for="text_3">Published on:</label>
<input type="text" name="text_3" id="text_3" value="Published On : ">
<br>
<label for="image_source">Enter the image source(thumbnail):</label>
<input type="text" name="image_source" id="image_source" value="https://test-site-romanjandas.000webhostapp.com/guwahati_local/glv1_modified/images/glocal_thumb.jpg">
<br><br>

<label for="image1">Enter the image1 source:</label>
<input type="text" name="image1" id="image1" value="https://test-site-romanjandas.000webhostapp.com/guwahati_local/glv1_modified/images/glocal.jpg"><br>
<label for="image2">Enter the image2 source:</label>
<input type="text" name="image2" id="image2" value="#" disabled><br>
<label for="image3">Enter the image3 source:</label>
<input type="text" name="image3" id="image3" value="#" disabled><br>

<label for="map_link">Enter the map url:</label>
<input type="text" name="map_link" id="map_link" value="#map#"><br>
...
<br>
<h1>
<a href="join_files.php" target="_blank">Click here to complete</a>
</h1><br>
...
<h1>
    ...
    <a href="https://justtesting123jsust.000webhostapp.com/index.html" target="_blank">index.html</a><br><br>
    <a href="https://justtesting123jsust.000webhostapp.com/index_1.php" target="_blank">index_1.php (data entry)</a><br><br>
    <a href="https://justtesting123jsust.000webhostapp.com/main_ad_ids.txt" target="_blank">main_ad_ids.txt (database)</a><br><br>
    <a href="https://justtesting123jsust.000webhostapp.com/main_ad_ids.js" target="_blank">main_ad_ids.js (ad id js file)</a><br><br>
</h1>
--->    
</body>
</html>